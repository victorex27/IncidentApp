...
public class OfficerLoginFragment extends Fragment {
    ...
    public static OfficerLoginFragment newInstance() {
        OfficerLoginFragment fragment = new OfficerLoginFragment();
...
//        bundle.putInt(ARG_SECTION_NUMBER, index);
    ...
    private void login(View view) {
        ...
        try {
            ...
            user = new Officer(emailText, passwordText);

            user.setDbHelper(new DbHelper(getContext()));

            Officer validUser = user.signIn();
            if (validUser == null)
